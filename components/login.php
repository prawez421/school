...
<body class="bg-gray-100 min-h-screen flex justify-center items-center">
    ...
    <div class="bg-white rounded-xl shadow-lg w-[95%] max-w-md">
        ...
        <!-- Form -->
        <form action="../backend/student-login.php" method="post" class="p-5">
    ...
    <!-- Toast -->
    <div id="toast"
class="fixed top-5 right-5 bg-green-600 text-white px-5 py-3 rounded-lg shadow-lg
translate-x-full opacity-0 transition-all duration-300 z-50">
</div>
...
<div id="toast"
class="fixed top-5 right-5 bg-green-600 text-white px-5 py-3 rounded-lg shadow-lg
opacity-0 translate-x-full transition-all duration-500 z-50">
</div>
